...
<html class="gr__adminlte_io" style="height: auto; min-height: 100%;"><head><meta http-equiv="Content-Type">
  <meta charset="utf-8">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar" style="height: auto;">
      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        <li class="header">MAIN </li><li class ='header'><a href='userMainPage.jsp'><i class='fa fa-dashboard'></i><span>创建标注任务</span></a></li><li class ='header'><a href='labelTaskBrowser.jsp'><i class='fa fa-dashboard'></i><span>浏览标注任务</span></a></li>
      </ul>
      ...
      <div class="browser-section box">
        <div class="box-header with-border" >
          ...
          <div id="pathNavigator">
            <a href="http://www.baidu.com">\projects</a>
            <a href="/Download">\2projects</a>
          </div>
        ...
        <div class="box-body">
          <ul id="taskBroswer" class="tree" data-widget="tree">
            ...
            <li style='list-style-type:none;margin:0px;padding:0px' >
              <a onclick="getNewPath('\\projects\\lucene');">
                <span>
                  <table class='table table-bordered' style='margin:0px'>
                    <tbody>
                      <tr>
                        <th class='task-ID'>{{pathName}}</th>
                        <th class='task-creator'>{{pathType}}</th>
                      </tr>
                    </tbody>
                  </table>
                </span>
              ...
              <ul class='treeview-menu'>
                <li>
                  <div style='margin:10px'>
                    <input type='text' name='q' class='form-control' placeholder='Search...'>
                    <a href='labelTask.jsp?taskID=1&pageIndex=0&dataIndex=0'>加入</a>
                  </div>
                </li>
              </ul>
            </li>
        ...
        <div class="box-footer clearfix">
          <ul id="taskBrowserFooter" class="pagination pagination-sm no-margin pull-right">
            <li><a href='image'>1</a></li><li><a href='labelTaskBrowser.jsp?index=1'>»</a></li>
            <!--
			<li>
				<a >«</a>
			</li>
...
<script id="pathTemplate" type="/text/x-handlebars-template">
  <li style='list-style-type:none;margin:0px;padding:0px' >
    <a onclick="getNewPath('{{newPath}}');">
      <span>
        <table class='table table-bordered' style='margin:0px'>
          <tbody>
            <tr>
...
<script id="pathNaviTemplate" type="/text/x-handlebars-template">
  <a onclick="getNewPath('{{absolutePath}}')">{{pathName}}</a>
</script>
